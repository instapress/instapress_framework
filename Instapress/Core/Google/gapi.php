...
class gapi
{
   ...
   */
  public function requestAccountData($start_index=1, $max_results=50)
  {
   ...
   * @param Int $max_results OPTIONAL: Max results returned
   */
  public function requestReportData($report_id, $dimensions, $metrics, $sort_metric=null, $filter=null, $start_date=null, $end_date=null, $start_index=1, $max_results=50)
  {
