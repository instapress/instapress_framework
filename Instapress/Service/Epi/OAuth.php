<?php
class Instapress_Service_Epi_OAuth
{
  public $version = '1.0';
  ...
  public function getAccessToken($params = null)
  {
    ...
    return new Instapress_Service_Epi_OAuthResponse($resp);
  }
  ...
  public function __construct($consumerKey, $consumerSecret, $signatureMethod='HMAC-SHA1')
  {
    ...
    $this->curl = Instapress_Service_Epi_Curl::getInstance();
  }
}

class Instapress_Service_Epi_OAuthResponse
{
  private $__resp;
  protected $debug = false;
  ...
  public function __get($name)
  {
    if($this->__resp->code != 200)
      Instapress_Service_Epi_OAuthException::raise($this->__resp, $this->debug);
...
class Instapress_Service_Epi_OAuthException extends Exception
{
  public static function raise($response, $debug)
  {
    ...
    {
      case 400:
        throw new Instapress_Service_Epi_OAuthBadRequestException($message, $response->code);
      case 401:
        throw new Instapress_Service_Epi_OAuthUnauthorizedException($message, $response->code);
      default:
        throw new Instapress_Service_Epi_OAuthException($message, $response->code);
    }
  }
}
class Instapress_Service_Epi_OAuthBadRequestException extends Instapress_Service_Epi_OAuthException{}
class Instapress_Service_Epi_OAuthUnauthorizedException extends Instapress_Service_Epi_OAuthException{}
