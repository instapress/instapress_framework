<?php
class Instapress_Service_Epi_Curl
{
  const timeout = 3;
  static $inst = null;
  static $singleton = 0;
  ...
  function __construct()
  {
    if(self::$singleton == 0)
    {
      throw new Exception('This class cannot be instantiated by the new keyword.  You must instantiate it using: $obj = Instapress_Service_Epi_Curl::getInstance();');
    }
  ...
  public function addEasyCurl($ch)
  {
    ...
    $this->startTimer($key);
    return new Instapress_Service_Epi_CurlManager($key);
  }
  ...
  {
    return new Instapress_Service_Epi_Sequence(self::$timers);
  }
  ...
  static function getInstance()
  {
    ...
    {
      self::$singleton = 1;
      self::$inst = new Instapress_Service_Epi_Curl();
    }
...
class Instapress_Service_Epi_CurlManager
{
  private $key;
  private $epiCurl;
  ...
  {
    $this->key = $key;
    $this->epiCurl = Instapress_Service_Epi_Curl::getInstance();
  }
