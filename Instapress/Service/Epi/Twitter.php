 ...
 */
class Instapress_Service_Epi_Twitter extends Instapress_Service_Epi_OAuth
{
  ...
  private function request($method, $endpoint, $params = null)
  {
    ...
    $resp= new Instapress_Service_Epi_TwitterJson(call_user_func(array($this, 'httpRequest'), $method, $url, $params, $this->isMultipart($params)), $this->debug);
  ...
  private function request_basic($method, $endpoint, $params = null, $username = null, $password = null)
  {
    ...
    $resp = new Instapress_Service_Epi_TwitterJson(Instapress_Service_Epi_Curl::getInstance()->addCurl($ch), $this->debug);
    if(!$this->isAsynchronous)
      $resp->response;
...
class Instapress_Service_Epi_TwitterJson implements ArrayAccess, Countable, IteratorAggregate
{
  private $debug;
  private $__resp;
  ...
  public function __get($name)
  {
    ...
    elseif(($this->code < 200 || $this->code >= 400) && !isset($accessible[$name]))
      Instapress_Service_Epi_TwitterException::raise($this->__resp, $this->debug);
...
class Instapress_Service_Epi_TwitterException extends Exception 
{
  public static function raise($response, $debug)
  {
    ...
    {
      case 400:
        throw new Instapress_Service_Epi_TwitterBadRequestException($message, $response->code);
      case 401:
        throw new Instapress_Service_Epi_TwitterNotAuthorizedException($message, $response->code);
      case 403:
        throw new Instapress_Service_Epi_TwitterForbiddenException($message, $response->code);
      case 404:
        throw new Instapress_Service_Epi_TwitterNotFoundException($message, $response->code);
      case 406:
        throw new Instapress_Service_Epi_TwitterNotAcceptableException($message, $response->code);
      case 420:
        throw new Instapress_Service_Epi_TwitterEnhanceYourCalmException($message, $response->code);
      case 500:
        throw new Instapress_Service_Epi_TwitterInternalServerException($message, $response->code);
      case 502:
        throw new Instapress_Service_Epi_TwitterBadGatewayException($message, $response->code);
      case 503:
        throw new Instapress_Service_Epi_TwitterServiceUnavailableException($message, $response->code);
      default:
        throw new Instapress_Service_Epi_TwitterException($message, $response->code);
    }
  }
}
class Instapress_Service_Epi_TwitterBadRequestException extends Instapress_Service_Epi_TwitterException{}
class Instapress_Service_Epi_TwitterNotAuthorizedException extends Instapress_Service_Epi_TwitterException{}
class Instapress_Service_Epi_TwitterForbiddenException extends Instapress_Service_Epi_TwitterException{}
class Instapress_Service_Epi_TwitterNotFoundException extends Instapress_Service_Epi_TwitterException{}
class Instapress_Service_Epi_TwitterNotAcceptableException extends Instapress_Service_Epi_TwitterException{}
class Instapress_Service_Epi_TwitterEnhanceYourCalmException extends Instapress_Service_Epi_TwitterException{}
class Instapress_Service_Epi_TwitterInternalServerException extends Instapress_Service_Epi_TwitterException{}
class Instapress_Service_Epi_TwitterBadGatewayException extends Instapress_Service_Epi_TwitterException{}
class Instapress_Service_Epi_TwitterServiceUnavailableException extends Instapress_Service_Epi_TwitterException{}
