...
function file_get_html() {
    $dom = new Instapress_Service_SimpleHtmlDom;
    $args = func_get_args();
...
// -----------------------------------------------------------------------------
class Instapress_Service_SimpleHtmlDomNode {
...
// -----------------------------------------------------------------------------
class Instapress_Service_SimpleHtmlDom {
    public $root = null;
    public $nodes = array();
    ...
    protected function prepare($str, $lowercase=true) {
        ...
        $this->root = new Instapress_Service_SimpleHtmlDom_node($this);
        $this->root->tag = 'root';
    ...
    protected function parse() {
        ...
        // text
        $node = new Instapress_Service_SimpleHtmlDomNode($this);
        ++$this->cursor;
