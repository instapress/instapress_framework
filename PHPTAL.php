...
class PHPTAL
{
    ...
    public function __construct($path=false)
    {
        ...
        $this->setTranslator( new PHPTAL_InstapressTranslator( $this->_context ) );
        ...
        if( APP_ENV != 'development' ) {
	        $normalizationObject = new PHPTAL_PreFilter_Compress();
    	    $this->addPreFilter( $normalizationObject );
        }
        */
    }
