 ...
 * {@link Log4Php_LoggerLoggingEvent}, then the {@link decide()} method returns
 ...
 * @since 0.6
 */
class  Log4Php_filters_LoggerFilterLevelMatch extends Log4Php_LoggerFilter {
	...
	public function setLevelToMatch($l) {
		if($l instanceof Log4Php_LoggerLevel) {
			...
			$this->levelToMatch = Log4Php_helpers_LoggerOptionConverter::toLevel($l, null);
		}
	}
	...
	public function decide(Log4Php_LoggerLoggingEvent $event) {
		...
		if($this->levelToMatch->equals($event->getLevel())) {	
			return $this->acceptOnMatch ? Log4Php_LoggerFilter::ACCEPT : Log4Php_LoggerFilter::DENY;
		} else {
			return Log4Php_LoggerFilter::NEUTRAL;
		}
	}
