 ...
 * @since 0.9
 */
class Log4Php_appenders_LoggerAppenderAdodb extends Log4Php_LoggerAppender {
	...
	{		
		...
		$this->layout = Log4Php_LoggerReflectionUtils::createObject('Log4Php_layout_LoggerLayoutPattern');
	...
	function append(Log4Php_LoggerLoggingEvent $event) {
		if ($this->canAppend) {
