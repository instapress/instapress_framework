 ...
 * @since 2.1
 */
class Log4Php_appenders_LoggerAppenderMongoDB extends Log4Php_LoggerAppender {
	...
	public function activateOptions() {
		try {
			...
			throw new Log4Php_LoggerException($ex);
		} 
	 ...
	 * 
	 * @throws Log4Php_LoggerException If the pattern conversion or the INSERT statement fails.
	 */
	 ...
	 */
	protected function format(Log4Php_LoggerLoggingEvent $event) {
