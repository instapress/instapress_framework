 ...
 */ 
class Log4Php_appenders_LoggerAppenderPhp extends Log4Php_LoggerAppender {
	...
	public function append(Log4Php_Log4Php_LoggerLoggingEvent $event) {
		if($this->layout !== null) {
			$level = $event->getLevel();
			if($level->isGreaterOrEqual(Log4Php_LoggerLevel::getLevelError())) {
