...
/**
 * LoggerAppenderRollingFile extends Log4Php_appenders_LoggerAppenderFile to backup the log files
 ...
 */
class Log4Php_appenders_LoggerAppenderRollingFile extends Log4Php_appenders_LoggerAppenderFile {
	...
	public function setFile($fileName) {
		$this->file = $fileName;
		// As Log4Php_appenders_LoggerAppenderFile does not create the directory, it has to exist.
