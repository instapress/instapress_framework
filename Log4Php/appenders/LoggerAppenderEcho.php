 ...
 */
class Log4Php_appenders_LoggerAppenderEcho extends Log4Php_LoggerAppender {
	...
	public function setHtmlLineBreaks($value) {
		$this->htmlLineBreaks = Log4Php_helpers_LoggerOptionConverter::toBoolean($value, false);
	}
