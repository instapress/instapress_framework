 ...
 *
 * If configured to do so, {@link LoggerPatternLayout} and {@link Log4Php_layouts_LoggerLayoutTTCC}
...
class Log4Php_LoggerNDC {
	...
	/**
	 * Never use this method directly, use the {@link Log4Php_LoggerLoggingEvent::getNDC()} method instead.
	 * @static
	 * @return array
	 */
	...
	public static function setMaxDepth($maxDepth) {
		...
		if(Log4Php_LoggerNDC::getDepth() > $maxDepth) {
