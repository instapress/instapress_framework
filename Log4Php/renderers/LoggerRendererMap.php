 ...
 * @since 0.3
 */
class Log4Php_renderers_LoggerRendererMap {
	...
	public function __construct() {
		$this->map = array();
		$this->defaultRenderer = new Log4Php_renderers_LoggerRendererDefault();
	}
	...
	public function addRenderer($renderedClassName, $renderingClassName) {
		$renderer = Log4Php_LoggerReflectionUtils::createObject($renderingClassName);
		if($renderer == null) {
			return;
		} else {
