 ...
 * @subpackage layouts
 */
class Log4Php_layouts_LoggerLayoutHtml extends Log4Php_LoggerLayout {
	...
	public function format(Log4Php_LoggerLoggingEvent $event) {
		...
		if ($level->equals(Log4Php_LoggerLevel::getLevelDebug())) {
			$sbuf .= "<font color=\"#339933\">$level</font>";
		} else if ($level->equals(Log4Php_LoggerLevel::getLevelWarn())) {
