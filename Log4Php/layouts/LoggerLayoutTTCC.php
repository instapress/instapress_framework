 ...
 * @subpackage layouts
 */
class Log4Php_layouts_LoggerLayoutTTCC extends Log4Php_LoggerLayout {
	...
	public function setCategoryPrefixing($categoryPrefixing) {
		$this->categoryPrefixing = Log4Php_helpers_LoggerOptionConverter::toBoolean($categoryPrefixing);
	}
	...
	public function setContextPrinting($contextPrinting) {
		$this->contextPrinting = Log4Php_helpers_LoggerOptionConverter::toBoolean($contextPrinting);
	}
