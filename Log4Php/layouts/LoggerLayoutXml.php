 ...
 * @subpackage layouts
 */
class Log4Php_layouts_LoggerLayoutXml extends Log4Php_LoggerLayout {
	...
	/**
	 * Formats a {@link Log4Php_LoggerLoggingEvent} in conformance with the log4php.dtd.
	 *
	 * @param Log4Php_LoggerLoggingEvent $event
	 * @return string
	 */
	public function format(Log4Php_LoggerLoggingEvent $event) {
	...
	public function setLocationInfo($flag) {
		$this->locationInfo = Log4Php_helpers_LoggerOptionConverter::toBoolean($flag, true);
	}
	...
	public function setLog4jNamespace($flag) {
		$this->log4jNamespace = Log4Php_helpers_LoggerOptionConverter::toBoolean($flag, true);
	}
