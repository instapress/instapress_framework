 ...
 * @see Logger
 */
class Log4Php_LoggerRoot extends Log4Php_Logger {
	/**
	 * Constructor
	 *
	...
	public function __construct($level = null) {
		...
		if($level == null) {
			$level = Log4Php_LoggerLevel::getLevelAll();
		}
		$this->setLevel($level);
	} 
	
	/**
	 * @return Log4Php_LoggerLevel the level
	 */
	 ...
	 * @return boolean
	 */
	public function setParent(Log4Php_Logger $parent) {
		return false;
	}
