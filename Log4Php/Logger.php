...
//spl_autoload_register(array('Log4Php_Logger', 'autoload'),false,true);
 ...
 */
class Log4Php_Logger {
	private static $_classes = array(
               
		'LoggerException' => '/LoggerException.php',
		'Log4Php_LoggerHierarchy' => '/LoggerHierarchy.php',
	...
	private $fqcn = 'Instapress_Log4Php_Logger';
	 ...
	 */
	private static $configurationClass = 'Log4Php_configurators_LoggerConfiguratorBasic';
	...
	public static function getHierarchy() {
		if(!isset(self::$hierarchy)) {
			self::$hierarchy = new Log4Php_LoggerHierarchy(new Log4Php_LoggerRoot());
		}
	...
	public function trace($message, $caller = null) {
		$this->log(Log4Php_LoggerLevel::getLevelTrace(), $message, $caller);
	} 		
	...
	public function debug($message, $caller = null) {
		$this->log(Log4Php_LoggerLevel::getLevelDebug(), $message, $caller);
	} 
	...
	public function info($message, $caller = null) {
		$this->log(Log4Php_LoggerLevel::getLevelInfo(), $message, $caller);
	}
	...
	public function warn($message, $caller = null) {
		$this->log(Log4Php_LoggerLevel::getLevelWarn(), $message, $caller);
	}
	...
	public function error($message, $caller = null) {
		$this->log(Log4Php_LoggerLevel::getLevelError(), $message, $caller);
	}
	...
	public function fatal($message, $caller = null) {
		$this->log(Log4Php_LoggerLevel::getLevelFatal(), $message, $caller);
	}
	...
	public function forcedLog($fqcn, $caller, $level, $message) {
		...
		$this->callAppenders(new Log4Php_LoggerLoggingEvent($fqcn, $this, $level, $message, null, $throwable));
	} 
	...
	public function isDebugEnabled() {
		return $this->isEnabledFor(Log4Php_LoggerLevel::getLevelDebug());
	}		
	...
	public function isInfoEnabled() {
		return $this->isEnabledFor(Log4Php_LoggerLevel::getLevelInfo());
	} 
	...
	public function removeAppender($appender) {
		if($appender instanceof Log4Php_LoggerAppender) {
			$appender->close();
	...
	public static function resetConfiguration() {
		...
		self::$configurationClass = 'Log4Php_configurators_LoggerConfiguratorBasic';
	 ...
	 * @return boolean
	 */
	public function isAttached(Log4Php_LoggerAppender $appender) {
	 ...
	 * @param Logger $logger
	 */
	public function setParent(Log4Php_Logger $logger) {
		$this->parent = $logger;
	} 
	...
	public static function configure($configurationFile = null, $configurationClass = null ) {
		...
		if (strtolower(substr( $configurationFile, -4 )) == '.xml') {
			self::$configurationFile = $configurationFile;
			self::$configurationClass = 'Log4Php_configurators_LoggerConfiguratorXml';
		} else {
			self::$configurationFile = $configurationFile;
	...
	public static function initialize() {
		...
		$instance = Log4Php_LoggerReflectionUtils::createObject(self::$configurationClass);
