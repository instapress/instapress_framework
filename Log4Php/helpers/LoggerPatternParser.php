 ...
 * is delegated to the {@link Log4Php_helpers_LoggerPatternParser} class.
 * 
 * <p>It is this class that parses conversion patterns and creates
 * a chained list of {@link Log4Php_helpers_LoggerPatternConverter} converters.</p>
 * 
 ...
 * @since 0.3
 */
class Log4Php_helpers_LoggerPatternParser {
	...
	/**
	 * @var Log4Php_helpers_LoggerPatternConverter
	 */
	private $head = null;
	...
	public function __construct($pattern) {
		...
		$this->formattingInfo = new Log4Php_helpers_LoggerFormattingInfo();
		$this->state = self::LITERAL_STATE;
	}

	/**
	 * @param Log4Php_helpers_LoggerPatternConverter $pc
	 */
	...
	/** Parser.
	 * 
	 * @return Log4Php_helpers_LoggerPatternConverter Returns $this->head.
	 */
						...
						switch($this->pattern{$this->i}) {
							...
							default:
								if(strlen($this->currentLiteral) != 0) {
									$this->addToList(new Log4Php_helpers_LoggerLiteralPatternConverter($this->currentLiteral));
								}
								$this->currentLiteral = $c;
	...
	public function finalizeConverter($c) {
		...
		switch($c) {
			case 'c':
				$pc = new Log4Php_helpers_LoggerCategoryPatternConverter($this->formattingInfo, $this->extractPrecisionOption());
				$this->currentLiteral = '';
				break;
			case 'C':
				$pc = new Log4Php_helpers_LoggerClassNamePatternConverter($this->formattingInfo, self::CLASS_LOCATION_CONVERTER);
				$this->currentLiteral = '';
				break;
			case 'd':
				...
				$pc = new Log4Php_helpers_LoggerDatePatternConverter($this->formattingInfo, $df);
				$this->currentLiteral = '';
				break;
			case 'F':
				$pc = new Log4Php_helpers_LoggerLocationPatternConverter($this->formattingInfo, self::FILE_LOCATION_CONVERTER);
				$this->currentLiteral = '';
				break;
			case 'l':
				$pc = new Log4Php_helpers_LoggerLocationPatternConverter($this->formattingInfo, self::FULL_LOCATION_CONVERTER);
				$this->currentLiteral = '';
				break;
			case 'L':
				$pc = new Log4Php_helpers_LoggerLocationPatternConverter($this->formattingInfo, self::LINE_LOCATION_CONVERTER);
				$this->currentLiteral = '';
				break;
			case 'm':
				$pc = new Log4Php_helpers_LoggerBasicPatternConverter($this->formattingInfo, self::MESSAGE_CONVERTER);
				$this->currentLiteral = '';
				break;
			case 'M':
				$pc = new Log4Php_helpers_LoggerLocationPatternConverter($this->formattingInfo, self::METHOD_LOCATION_CONVERTER);
				$this->currentLiteral = '';
				break;
			case 'p':
				$pc = new Log4Php_helpers_LoggerBasicPatternConverter($this->formattingInfo, self::LEVEL_CONVERTER);
				$this->currentLiteral = '';
				break;
			case 'r':
				$pc = new Log4Php_helpers_LoggerBasicPatternConverter($this->formattingInfo, self::RELATIVE_TIME_CONVERTER);
				$this->currentLiteral = '';
				break;
			case 't':
				$pc = new Log4Php_helpers_LoggerBasicPatternConverter($this->formattingInfo, self::THREAD_CONVERTER);
				$this->currentLiteral = '';
				break;
			case 'u':
				if($this->i < $this->patternLength) {
				...
				break;
			case 'x':
				$pc = new Log4Php_helpers_LoggerBasicPatternConverter($this->formattingInfo, self::NDC_CONVERTER);
				$this->currentLiteral = '';
				break;
			case 'X':
				$xOpt = $this->extractOption();
				$pc = new Log4Php_helpers_LoggerMDCPatternConverter($this->formattingInfo, $xOpt);
				$this->currentLiteral = '';
				break;
			default:
				$pc = new Log4Php_helpers_LoggerLiteralPatternConverter($this->currentLiteral);
				$this->currentLiteral = '';
		}
